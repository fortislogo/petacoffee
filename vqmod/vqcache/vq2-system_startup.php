...
require_once($vqmod->modCheck(DIR_SYSTEM . 'helper/crypt.php')); 
require_once($vqmod->modCheck(DIR_SYSTEM . 'helper/blowfish.php')); 
...
require_once($vqmod->modCheck(DIR_SYSTEM . 'library/template.php'));
        ...
        require_once($vqmod->modCheck(DIR_SYSTEM . 'library/ocw.php'));

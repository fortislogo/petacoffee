<table class="form">
  ...
  <tr>
    ...
    <td><select name="country_id" class="large-field" onchange="$('#shipping-address select[name=\'zone_id\']').load('index.php?route=onecheckout/address/zone&country_id=' + this.value);">
...
$('#shipping-address select[name=\'zone_id\']').load('index.php?route=onecheckout/address/zone&country_id=<?php echo $country_id; ?>&zone_id=<?php echo $zone_id; ?>');
//--></script>
...
<script type="text/javascript" src="catalog/view/javascript/jquery/onefancybox/jquery.fancybox-1.3.4.pack.js"></script>
<link rel="stylesheet" type="text/css" href="catalog/view/javascript/jquery/onefancybox/jquery.fancybox-1.3.4.css" media="screen" /> 
...
if($('.onecheckout-content .error:first').html()) {
  ...
  $('.warning').fadeIn('slow');	
	...
	$.ajax({
		...
		type: 'post',
		data: $('#confirm input[type=\'checkbox\']:checked, #confirm select'),
		dataType: 'json',
		beforeSend: function() {

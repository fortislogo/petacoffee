...
<div id="<?php echo $type; ?>-new" style="display: none;">
  <table class="form">
    ...
    <tr>
      ...
      <td><select name="country_id" class="large-field" onchange="$('#<?php echo $type; ?>-address select[name=\'zone_id\']').load('index.php?route=onecheckout/address/zone&country_id=' + this.value);">
...
$('#<?php echo $type; ?>-address select[name=\'zone_id\']').load('index.php?route=onecheckout/address/zone&country_id=<?php echo $country_id; ?>');

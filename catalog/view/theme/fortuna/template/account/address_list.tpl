					...
					<?php foreach ($addresses as $result) { ?>
						...
						<div class="row-fluid">
							...
							<div class="span6 list-actions">
								<a href="<?php echo $result['update']; ?>" class="btn btn-mini" title="<?php echo $button_edit; ?>"><?php echo $button_edit; ?></a>
								<a href="<?php echo $result['delete']; ?>" class="btn btn-mini" title="<?php echo $button_delete; ?>"><i class="icon-trash"></i></a>
							</div>

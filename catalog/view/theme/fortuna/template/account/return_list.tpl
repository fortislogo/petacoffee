					...
					<div class="return-list">
						...
						<?php foreach ($returns as $return) { ?>
							...
							<div class="contentset">
								<h4 class="inner">
									<span><?php echo $text_return_id; ?> <?php echo $return['return_id']; ?></span>
								</h4>
							</div>
							...
							<div class="row-fluid">
								...
								<div class="span2 list-actions">
									<a href="<?php echo $return['href']; ?>" class="btn btn-mini" title="<?php echo $button_view; ?>"><?php echo $button_view; ?></a>
								</div>

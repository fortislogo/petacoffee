						...
						<?php foreach ($products as $product) { ?>
							...
							<div id="wishlist-row<?php echo $product['product_id']; ?>" class="row-fluid">
								...
								<div class="span3 list-actions">
									<a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="btn btn-cart btn-small" title="<?php echo $button_cart; ?>" >
										<?php echo $button_cart; ?>
									</a>
									<a href="<?php echo $product['remove']; ?>" class="btn btn-small" title="<?php echo $button_remove; ?>">

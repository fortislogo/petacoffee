			...
			<div class="mainborder">
				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="recurring_form" class="form-horizontal">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                        	<td id="addresses">
                            	<input type="radio" name="use_address" value="existing-address" checked="checked"> Use existing address
                                ...
                                <input type="radio" name="use_address" value="new-address"> New address
...
<script>
$('#addresses input[type=radio]').bind('click', function()
{														 
	$('#addresses div').hide();
	$('#addresses #' + $(this).val()).show();
});

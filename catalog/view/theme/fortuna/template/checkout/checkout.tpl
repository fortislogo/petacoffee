<?php echo $header; ?>
	...
	$('#button-shipping-method').live('click', function() {
		...
		$.ajax({
			...
			type: 'post',
			data: $('#shipping-method input[type=\'radio\']:checked, #shipping-method textarea, #shipping-method select, #shipping-method input[type=checkbox]:checked'),
			dataType: 'json',
			beforeSend: function() {
	...
	$('#button-payment-method').live('click', function() {
		...
		$.ajax({
			...
			type: 'post',
			data: $('#payment-method input[type=\'radio\']:checked, #payment-method input[type=\'checkbox\']:checked, #payment-method textarea, #payment-method select'),
			dataType: 'json',
			beforeSend: function() {

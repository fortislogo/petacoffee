<?php
class ModelRecurringAuthorizeNetAim extends Controller {
	...
	public function confirm() {
		...
		$recurring_info = $this->model_account_recurring->getRecurringOrder($this->request->get['id']);
		
		$cc = unserialize($recurring_info['cc']);
		...
		$data['x_card_num'] = str_replace(' ', '', $cc['card_num']);
		$data['x_exp_date'] = substr($cc['exp_date'],0,2) . substr($cc['exp_date'],-4);
		$data['x_card_code'] = $cc['card_code'];

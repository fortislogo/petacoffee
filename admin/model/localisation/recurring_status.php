<?php 
class ModelLocalisationRecurringStatus extends Model {
	public function addRecurringStatus($data) {
	...
	public function editRecurringStatus($order_status_id, $data) {
	...
	public function deleteRecurringStatus($order_status_id) {
		$this->db->query("DELETE FROM " . DB_PREFIX . "order_status WHERE order_status_id = '" . (int)$order_status_id . "'");
	
		$this->cache->delete('order_status');
	}
		
	public function getRecurringStatus($order_status_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_status WHERE order_status_id = '" . (int)$order_status_id . "' AND language_id = '" . (int)$this->config->get('config_language_id') . "'");
		
		return $query->row;
	}
		
	public function getRecurringStatuses($data = array()) {
      	if ($data) {
	...
	public function getRecurringStatusDescriptions($order_status_id) {
	...
	public function getTotalRecurringStatuses() {

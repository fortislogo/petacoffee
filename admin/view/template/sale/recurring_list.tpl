      ...
      <form action="" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="right"><?php if ($sort == 'o.order_id') { ?>
                <a href="<?php echo $sort_order; ?>" class="<?php echo strtolower($order); ?>">Recurring ID</a>
                <?php } else { ?>
                <a href="<?php echo $sort_order; ?>">Recurring ID</a>
                <?php } ?></td>
              ...
              <td class="right"><?php if ($sort == 'o.total') { ?>
                <a href="<?php echo $sort_total; ?>" class="<?php echo strtolower($order); ?>">Total Amount</a>
                <?php } else { ?>
              ...
              <td class="left"><?php if ($sort == 'o.date_modified') { ?>
                <a href="<?php echo $sort_date_modified; ?>" class="<?php echo strtolower($order); ?>">Next Order Date</a>
                <?php } else { ?>
                <a href="<?php echo $sort_date_modified; ?>">Next Order Date</a>
                <?php } ?></td>
          ...
          <tbody>
            <tr class="filter">
              <td></td>
              <td align="right"><input type="text" name="filter_order_id" value="<?php echo $filter_recurring_id; ?>" size="4" style="text-align: right;" /></td>
            ...
            <tr>
              ...
              <td class="left"><?php echo $order['next_order_date']; ?></td>

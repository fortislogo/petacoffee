  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="sale"><a class="top"><?php echo $text_sale; ?></a>
        <ul>
          <li>
          	 <a class="parent"><?php echo $text_order; ?></a>
          	 <ul>
          		<li><a href="<?php echo $order; ?>">Order List</a></li>
                <li><a href="<?php echo $update_order_status; ?>">Update Order Status</a></li>
             </ul>
          </li>
          <li><a href="<?php echo HTTP_SERVER ?>?route=sale/recurring&token=<?php echo $this->session->data['token'] ?>">Recurring Orders</a></li>
